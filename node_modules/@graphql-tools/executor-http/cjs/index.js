    ...
    const baseExecutor = (request) => {
        ...
        return new value_or_promise_1.ValueOrPromise(() => {
            ...
            if (typeof e === 'string') {
                ...
                return createResultForAbort(signal, {
                    requestBody: {
                        query,
                        operationName: request.operationName,
                    },
...
function createResultForAbort(signal, extensions, originalError) {
    return {
        errors: [
            (0, utils_1.createGraphQLError)('The operation was aborted. reason: ' + signal.reason, {
                extensions,
                originalError,
            }),
        ],
